...
END
    ...
    SELECT C.customer_id, C.first_name +' '+ C.last_name AS customer_name,
           CAST(A.house_number AS VARCHAR(10))+' '+ 
		   A.street +', '+ 
		   A.city +', '+ 
		   A.province +' '+ 
...
CREATE PROCEDURE OpenSavingsAccount
    @CustomerId INT,
    @InitialDeposit DECIMAL(15,2),
...
--======================--
-- 6. Checking Account Deposit
CREATE PROCEDURE DepositToChequing
    @CustomerId INT,
    @Amount DECIMAL(15,2)
AS
BEGIN
...
--======================--
-- 7. Checking Account Withdrawal
CREATE PROCEDURE WithdrawFromChequing
    @CustomerId INT,
    @Amount DECIMAL(15,2)
AS
BEGIN
...
CREATE PROCEDURE CustomerLoanHistory
    @CustomerID INT
AS
BEGIN
    SET NOCOUNT ON;
...
--======================--
-- 9. Paying Loan
CREATE PROCEDURE PayCustomerLoan
    @CustomerID INT,
    @LoanID INT,
    @Amount DECIMAL(15,2)
AS
